...
class TravelService extends cds.ApplicationService {
  init() {
     ...
     * @param CustomerID *
     * @returns BookingData */ this.on('getBookingDataOfPassenger', async (req) => { const { CustomerID } = req.data 
     ...
     allCustomerBookings.forEach((booking) => { bookingData.TotalBookingsCount++ 
